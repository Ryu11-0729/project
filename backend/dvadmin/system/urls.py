...
from dvadmin.system.views.data_analyze_predict import DataAnalyzePredictViewSet
...
urlpatterns = [
    path('data_analyze/', DataAnalyzePredictViewSet.as_view({'get': 'data_analyze'})),
    path('data_predict/', DataAnalyzePredictViewSet.as_view({'get': 'data_predict'})),
